...
notes=$(find ./notes/ | grep 'L3[0-9]*\.pdf' | sort)
gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=p2.pdf $notes

notes=$(echo p0.pdf p1.pdf p2.pdf)
gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=post.pdf $notes

rm p0.pdf p1.pdf p2.pdf
